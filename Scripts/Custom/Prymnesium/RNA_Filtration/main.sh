...
# Ce script est le script principal permettant de lancer la pipeline de traitement du transcriptome de Prymnesium.
...
CONSENSUS="/home1/datawork/ltrouill/Ifremer/Results/Prymnesium/trinity/Trinity_20250819_113303.Trinity.fasta"
...
cd /home1/datawork/ltrouill/Ifremer/Scripts/Prymnesium/RNA_Filtration

echo "[$(date)] Début de la pipeline - Séparation selon les types d'ARN" > "$LOG_FILE"

echo "Espèce : Prymnesium " >> "$LOG_FILE"
