...
SHORT_READS_FOLDER="Chemin/vers/le/dossier/short_reads/"
LOG_FOLDER="Chemin/vers/le/dossier/logs/fastp"
RESULT_FOLDER="Chemin/vers/le/dossier/fastp_${TIMESTAMP}"
