...
TRANSCRIPTOME_1="Chemin/vers/transcriptome1.fasta"
TRANSCRIPTOME_2="Chemin/vers/transcriptome2.fasta"
NAME=Nom_espece
EVIGINE_FOLDER="/Chemin/vers/Transcriptome_${NAME}_$(date +%Y%m%d_%H%M%S)"
